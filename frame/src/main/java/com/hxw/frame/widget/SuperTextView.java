...
public class SuperTextView extends RelativeLayout {
    ...
    private AppCompatImageView leftIconIV;//左边图标
    private AppCompatImageView rightIconIV;//右边图标
    private AppCompatCheckBox rightCheckBox;//右边checkbox
    private int rightCheckBoxBg;//checkBox的背景

    private AppCompatTextView leftTV;//左边textView
    private AppCompatTextView centerTV;//中间textView
    private AppCompatTextView rightTV;//右边textView

    private AppCompatTextView leftTopTV;//左上的textView
    private AppCompatTextView leftBottomTV;//左下的textView
    private AppCompatTextView leftBottomTV2;//左下第二个textView
...
//        defaultLinePadding = dip2px(context, 16);
        ...
        centerSpaceHeight = dip2px(context, 8);
        getAttr(attrs);
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        ////////设置文字或者图片资源////////
        leftIconRes = typedArray.getResourceId(R.styleable.SuperTextView_sLeftIconRes, -1);
        rightIconRes = typedArray.getResourceId(R.styleable.SuperTextView_sRightIconRes, -1);
        rightCheckBoxBg = typedArray.getResourceId(R.styleable.SuperTextView_sRightCheckBoxRes, -1);
    ...
    private void initSuperTextView() {
        ...
        if (mBackground_drawable != null) {
            this.setBackground(mBackground_drawable);
        }
    }
    ...
    private void initLeftBottomText2() {
        leftBottomTV2 = new AppCompatTextView(mContext);
    ...
    private void initRightText() {
        ...
        setTextViewRightDrawable(rightTV, rightTextStringRightIconRes, rightTextStringRightIconPadding);
    ...
    private void initRightIcon() {
        rightIconIV = new AppCompatImageView(mContext);
        ...
        if (rightIconRes != -1) {
            rightIconIV.setImageResource(rightIconRes);
        }
        addView(rightIconIV);
    }
     ...
     * @return 返回对象
     */
    public SuperTextView setLeftIcon(int leftIcon) {
     ...
     * @return 返回对象
     */
    public SuperTextView setRightIcon(int rightIcon) {
     ...
     * 设置checkbox的背景图
     *
     * @param res drawable资源对象
     * @return 返回对象
     */
    public SuperTextView setCbBackground(int res) {
        rightCheckBoxBg = res;
        if (rightCheckBox == null) {
            initRightCheckBox();
        } else {
            rightCheckBox.setBackgroundResource(res);
        }
        return this;
    }
    ...
    public static void setTextViewRightDrawable(TextView textView, Drawable drawable, int drawablePadding) {
