...
public class CommonTextView extends RelativeLayout {
    ...
    private int mLeft_IV_drawable;
    private int mRight_IV_drawable;
    ...
    private AppCompatTextView leftTextView, centerTextView, rightTextView;
    private AppCompatTextView leftTopTextView, centerTopTextView, rightTopTextView;
    private AppCompatTextView leftBottomTextView, centerBottomTextView, rightBottomTextView;
    ...
    private LayoutParams rightIVParams;
    ...
    public CommonTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultPadding = dip2px(context, 8);
        mCenterSpaceHeight = dip2px(context, 4);
        getAttr(attrs);
        init();
    }
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        mLeft_IV_drawable = typedArray.getResourceId(R.styleable.CommonTextView_cLeftImageViewDrawableRes, -1);
        mRight_IV_drawable = typedArray.getResourceId(R.styleable.CommonTextView_cRightImageViewDrawableRes, -1);
        /////////////////////
    ...
    private void init() {
        ...
        initLineView();
        initCenterBaseLine();
        if (mLeft_IV_drawable != -1) {
            initLeftImageView();
        }
        if (mRight_IV_drawable != -1) {
            initRightImageView();
        }
    ...
    private void initLeftImageView() {
        leftImageView = new AppCompatImageView(mContext);
        ...
        if (mLeft_IV_drawable != -1) {
            leftImageView.setImageResource(mLeft_IV_drawable);
        }
    ...
    private void initRightImageView() {
        rightImageView = new AppCompatImageView(mContext);
        ...
        if (mRight_IV_drawable != -1) {
            rightImageView.setImageResource(mRight_IV_drawable);
        }
...
//            rightTextView.setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
     ...
     * @return 返回
     */
    public AppCompatTextView initText(AppCompatTextView textView, LayoutParams layoutParams, int id, int textColor, int textSize) {
        if (textView == null) {
